<?php
require(INCLUDE_PATH . 'model/Unicredit/files/IGFS_CG_API/init/BaseIgfsCgInit.php');
require(INCLUDE_PATH . 'model/Unicredit/files/IGFS_CG_API/Level3Info.php');
require(INCLUDE_PATH . 'model/Unicredit/files/IGFS_CG_API/MandateInfo.php');
...
class IgfsCgInit extends BaseIgfsCgInit
{
	...
	{
		return INCLUDE_PATH . 'model/Unicredit/files/IGFS_CG_API/init/IgfsCgInit.request';
	}
}
